...
WORKDIR /src
COPY ["Rusv.UserManagement.Api.csproj", "Rusv.UserManagement.Api/"]
RUN dotnet restore "Rusv.UserManagement.Api/Rusv.UserManagement.Api.csproj"

WORKDIR "/src/Rusv.UserManagement.Api"
COPY . .
RUN dotnet build "Rusv.UserManagement.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Rusv.UserManagement.Api.csproj" \
...
Execute unit tests
```
    cd "Rusv.UserManagement.Api/test/Rusv.UserManagement.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Rusv.UserManagement.Api/src/Rusv.UserManagement.Api"
